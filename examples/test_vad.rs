// Test to check VAD flag and signal_type
...
fn main() {
    ...
    println!("Encoder VAD: {}", enc_state.s_cmn.vad_flags[0]);
    println!("Encoder signal_type: {}", enc_state.s_cmn.indices.signal_type);
    ...
    println!("\nDecoded {} samples", n);
    println!("Decoder VAD: {}", dec.channel_state[0].vad_flags[0]);
    println!("Decoder signal_type: {}", dec.channel_state[0].indices.signal_type);
}
